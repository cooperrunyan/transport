...
export const SearchIcon: React.FC<SVGAttributes<SVGElement>> = props => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" color="var(--grey-10)" {...props}>
    <path
      ...
      strokeMiterlimit="10"
    />
    <path d="M10.5715 10.5716L14 14" stroke="currentColor" strokeMiterlimit="10" strokeLinecap="round" />
  </svg>
);
